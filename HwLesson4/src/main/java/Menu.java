...
public class Menu {
    private static final String path = "./src/main/java/plans.txt";
    ...
    public static void startWork() {
        ...
        scheduleAddNotes.addSchedule(new Schedule(1, "Иван Петрович", "Забить гвоздь", LocalDateTime.of(23, 02, 26, 16, 10, 20),
                LocalDateTime.of(2023, 03, 10, 14, 05), Priority.IMMIDIATE));
        scheduleAddNotes.addSchedule(new Schedule(2, "Пётр Иванович", "Погладить кота", LocalDateTime.of(2023, 02, 20, 12, 20, 20),
                LocalDateTime.of(2023, 03, 05, 10, 05), Priority.MIDDLE));
        scheduleAddNotes.addSchedule(new Schedule(3, "Мария Васильевна", "Приготовить борщ", LocalDateTime.of(23, 02, 25, 12, 00),
                LocalDateTime.of(23, 03, 14, 19, 00), Priority.LOW));
    ...
    public static void removeSchedule() {
        ...
        Objects.requireNonNull(scheduleAddNotes).removeSchedule(scheduleAddNotes.getSchedals().get(num - 1));
